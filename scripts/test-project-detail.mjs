...
reference.main=reference.main.replaceAll('分享','另存为 ZIP');const ref=parseHTML(reference.main).document.querySelector('li');assert.equal(await page.locator('[data-project-chat-id]').first().getAttribute('class'),ref.className);
...
else if(path==='/api/bookmarks'&&req.method()==='GET')result={bookmarks:[],writable:true};
